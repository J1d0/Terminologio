...
<body>
    <h2 class="illustration-title">Choix de la langue pour <?php echo e($illustration->title); ?></h2>
    ...
    <div id="langues">
        ...
        <form action="<?php echo e(route('illustration.editTranslation', ['imagePath' => $illustration->image_path])); ?>" method="POST">
            <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        if (options[0].value === "<?php echo e($illustration->default_language); ?>") {
            options[0].style.display = 'none';
            selectElement.selectedIndex = 1;
        } else {
            for (var i = 1; i < options.length; i++) {
                if (options[i].value === "<?php echo e($illustration->default_language); ?>") {
...
</html><?php /**PATH /home/lucas/Téléchargements/Projfinal/Terminologio/resources/views/illustration/translations.blade.php ENDPATH**/ ?>