...
<body>
    ...
    <form action="<?php echo e(route('illustration.newIllustration')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div>
...
</html><?php /**PATH /home/lucas/Téléchargements/Projfinal/Terminologio/resources/views/illustration/add.blade.php ENDPATH**/ ?>