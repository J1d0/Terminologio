...
<head>
    ...
    <a href="<?php echo e(route('illustration.cancel', ['imagePath' => $imagePath])); ?>" class="accueil-link" >Accueil</a>
...
<body>
    ...
    <div id="image-container">
        ...
        <img id="illustration" src="<?php echo e(Storage::url($imagePath)); ?>" alt="Illustration" style="max-width: 100%;">
    </div>
    ...
    <form id="components-form" action="<?php echo e(route('illustration.store', ['imageTitle' => $imageTitle, 'domain' => $domain, 'language' => $language, 'imagePath' => $imagePath])); ?>" method="POST">
        <?php echo csrf_field(); ?>
    </form>
...
<?php /**PATH /home/lucas/Téléchargements/Projfinal/Terminologio/resources/views/illustration/design_comp.blade.php ENDPATH**/ ?>